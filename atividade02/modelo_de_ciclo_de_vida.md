...
**Felipe Lisboa Brasil** | Matrícula: 202404940029
*Ciência da Computação – Instituto de Ciências Exatas e Naturais (UFPA)*

**Alessandro Reali Lopes Silva** | Matrícula: 202304940049
*Ciência da Computação – Instituto de Ciências Exatas e Naturais (UFPA)*
</div>
...
| Modelo | Filosofia | Requisitos | Entrega | Feedback | Risco | Documentação | Custo Mudança | Ideal para... |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Cascata** | Linear | Fixos no início | Final (Única) | Tardio | Reativo | Exaustiva | Altíssimo | Projetos Críticos |
| **Prototipagem** | Experimental | Incertos | Protótipos | Constante | Baixo (UX) | Mínima | Baixo | Validar Requisitos |
| **RAD** | Velocidade | Modularizáveis | Por Módulo | Alto | Médio | Suficiente | Baixo | Sistemas Modulares |
| **Incremental** | Partição | Evolutivos | Por Partes | Frequente | Distribuído | Moderada | Médio | Entrega de Valor Cedo |
| **Evolucionário** | Refinamento | Em Evolução | Versões | Cíclico | Controlado | Dinâmica | Baixo | Sistemas Adaptáveis |
| **Espiral** | Redução Danos | Complexos | Ciclo PDCA | Constante | Mínimo | Alta (Riscos) | Baixo | Projetos de Alto Risco |
